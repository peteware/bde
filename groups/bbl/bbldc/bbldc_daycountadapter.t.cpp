// bbldc_daycountadapter.t.cpp                                        -*-C++-*-

#include <bbldc_daycountadapter.h>
...
// fraction between two dates.  The general plan is that the methods are tested
// with two different templatizations to ensure the methods forward correctly.
// ----------------------------------------------------------------------------
...
//..
      ...
      case 1: {
        ...
        {
            {
                bbldc::DayCountAdapter<bbldcu::IsdaActualActual> mX;
            ...
            {
                bbldc::DayCountAdapter<bbldcu::Isma30360> mX;
                const bbldc::DayCountInterface&           protocol = mX;
