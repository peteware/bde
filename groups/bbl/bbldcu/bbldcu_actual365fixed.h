...
//
//@CLASSES:
//  bbldcu::Actual365Fixed: functions relating to Actual/365 fixed convention
//
...
// 'bbldcu::Actual365Fixed' methods.  First, create two 'bdlt::Dates' 'd1' and
// 'd2'.
//..
