...
void test15(int)
    ...
    //
    // Concerns:
    //   That all preconditions of all functions in this component are indeed
    //   tested by asserts.
    //
    // Plan:
    //   Use 'ASSERT_PASS', 'ASSERT_FAIL', etc, to verify checking.
    // ------------------------------------------------------------------------
{
    {
...
void test14(int)
    ...
    //
    // Concerns:
    //   That the behavior of 'xorEq' matches the bitwise C expression.
    //
    // Plan:
    //   Since 'bitN' of the result is never affected in any way by
    //   'bitM' of the operands, unless 'N == M', we can just test
    //   exhaustively test for all combinations of the first 8 bits,
    //   repeated over the word.
    // ------------------------------------------------------------------------
{
...
void test13(int)
    ...
    //
    // Concerns:
    //   That the behavior of 'setEq' matches the bitwise C expression.
    //
    // Plan:
    //   Since 'bitN' of the result is never affected in any way by
    //   'bitM' of the operands, unless 'N == M', we can just test
...
void test12(int)
    ...
    //
    // Concerns:
    //   That the behavior of 'orEq' matches the bitwise C expression.
    //
    // Plan:
    //   Since 'bitN' of the result is never affected in any way by
    //   'bitM' of the operands, unless 'N == M', we can just test
...
void test11(int)
    ...
    //
    // Concerns:
    //   That the behavior of 'minusEq' matches the bitwise C expression.
    //
    // Plan:
    //   Since 'bitN' of the result is never affected in any way by
    //   'bitM' of the operands, unless 'N == M', we can just test
...
void test10(int)
    ...
    //
    // Concerns:
    //   That the behavior of 'andEq' matches the bitwise C expression.
    //
    // Plan:
    //   Since 'bitN' of the result is never affected in any way by
    //   'bitM' of the operands, unless 'N == M', we can just test
...
void test9(int)
    ...
    //   look-up table (that must be tested exhaustively).  The other
        ...
        for (i = 0; i < NUM_DATA; ++i) {
            ...
            for (j = 0; j < NUM_DATA; ++j) {
                ...
                const int EXPECTED = (EXPECTED_HI < 0) ? EXPECTED_LO
                                                       : EXPECTED_HI + 32;
                long long src      = ((uint64_t)srcHi << 32)
                                    | (uint64_t)srcLo;
    ...
    // ------------------------------------------------------------------------
{
    ...
    for (int di = 0; di < NUM_DATA_B; ++di) {
        ...
        Util::setEqBits(&dst, DATA_B[di].d_index, val, DATA_B[di].d_numBits);
...
void test3(int)
    ...
    //
    // Concerns
    //   The the enum defined by the class is as expected.
    // ------------------------------------------------------------------------
{
    if (verbose) cout << endl
