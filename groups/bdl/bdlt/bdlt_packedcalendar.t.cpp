...
//                              Overview
//                              --------
// A 'bdet_PackedCalendar' is a value-semantic type that represents a
...
//
// We have chosen the primary manipulators for 'bdet_PackedCalendar' to be
// 'addDay', 'addHoliday', 'addHolidayCode', 'addWeekendDaysTransition', and
// 'removeAll'.
//
// We have chosen the basic accessors for 'bdet_PackedCalendar' to be
...
//
// CREATORS
// [ 2] bdet_PackedCalendar(bslma::Allocator *basicAllocator = 0);
// [11] bdet_PackedCalendar(const bdet_Date& firstDate, lastDate, ba = 0);
// [ 7] bdet_PackedCalendar(const bdet_PackedCalendar& original, ba = 0);
// [ 2] ~bdet_PackedCalendar();
//
// MANIPULATORS
// [ 9] bdet_PackedCalendar& operator=(const bdet_PackedCalendar& rhs);
...
// [12] void addWeekendDays(const bdet_DayOfWeekSet& weekendDays);
// [ 2] void addWeekendDaysTransition(date, weekendDays);
// [20] void intersectBusinessDays(const bdet_PackedCalendar& calendar);
// [21] void intersectNonBusinessDays(const bdet_PackedCalendar& calendar);
// [21] void unionBusinessDays(const bdet_PackedCalendar& calendar);
// [20] void unionNonBusinessDays(const bdet_PackedCalendar& calendar);
// [19] void removeHoliday(const bdet_Date& date);
// [19] void removeHolidayCode(const bdet_Date& date, int holidayCode);
// [ 2] void removeAll();
// [22] void swap(bdet_PackedCalendar& other);
// [22] void swap(bdet_PackedCalendar& lhs, bdet_PackedCalendar& rhs);
...
//
// FREE OPERATORS
// [ 6] operator==(const bdet_PackedCalendar& lhs, rhs);
// [ 6] operator!=(const bdet_PackedCalendar& lhs, rhs);
// [ 5] operator<<(ostream&, const bdet_PackedCalendar&);
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [23] USAGE EXAMPLE
...
typedef bdet_PackedCalendar Obj;
...
bdet_PackedCalendar& hh(bdet_PackedCalendar *object, const char *spec)
...
int ggg(bdet_PackedCalendar *object, const char *spec, bool verboseFlag =true)
...
bdet_PackedCalendar gg(bdet_PackedCalendar * object, const char *spec)
    // Return, by reference, the specified object with its value adjusted
    // according to the specified 'spec' according to the custom language
    // described above (in the test driver).
{
...
DEFINE_TEST_CASE(22) {
        ...
        //
        // Testing:
        //      void swap(bdet_PackedCalendar&);
        //      void swap(bdet_PackedCalendar&, bdet_PackedCalendar&);
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(20) {
        ...
        //
        // Testing:
        //      void intersectBusinessDays(const bdet_PackedCalendar&)
        //      void unionNonBusinessDays(const bdet_PackedCalendar&)
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(15) {
        ...
        for (int ts = 0; ts < NUM_DATA_LIST; ++ts) {
            ...
            const bdet_Date FIRST_DATE(bdet_Date(DATA[0].d_year,
                                                 DATA[0].d_month,
                                                 DATA[0].d_day) - 20);
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                typedef bsl::vector<bsl::pair<bdet_Date, bdet_DayOfWeekSet> >
                    TransitionVector;
                ...
                for (bsl::vector<bdet_Date>::const_iterator itr =
                                                              holidays.begin();
                     itr != holidays.end();
                     ++itr) {
                    mX.addHoliday(*itr);
...
DEFINE_TEST_CASE(13) {
        ...
        for (int i = 0; i <= 0x7F; ++i) {
            bdet_PackedCalendar obj(&testAllocator);
...
DEFINE_TEST_CASE(12) {
        ...
        //     'bdet_DayOfWeekSet' to the calendar object.  If the calendar
...
DEFINE_TEST_CASE(6) {
        ...
        //
        // Concerns:
        //   1. 'operator==' returns true if two 'bdet_packedCalendar' objects
...
DEFINE_TEST_CASE(5) {
        ...
        //  'bdet_packedCalendar' object for output with any valid 'level' and
        ...
        //
        // Plan:
        //  We will set up a set of 'bdet_packedCalendar' objects with
        ...
        //
        // Testing:
        //      bsl::ostream& bdet_PackedCalendar::print(
        //                                  bsl::ostream& stream,
        //                                  int           level,
...
DEFINE_TEST_CASE(4) {
        ...
        //
        // We want to first test the 'bdet_PackedCalendar_IteratorDateProxy'
        ...
        //
        // Concerns:
        //  1. The class 'bdet_PackedCalendar_IteratorDateProxy' properly
        ...
        //  9. 'isHoliday', and 'isWeekendDay(bdet_DayOfWeek::Day)' properly
        ...
        //  'bdet_PackedCalendar_IteratorDateProxy' object based on a
        ...
        {
            // Testing the 'bdet_PackedCalendar_IteratorDateProxy' class

            if (verbose) cout << endl
                    << "Testing 'bdet_PackedCalendar_IteratorDateProxy' class"
                    << endl
                    << "====================================================="
                    << endl;
            ...
            // Do the same test on a the smallest and the largest dates
            {
                ...
                bdet_PackedCalendar_IteratorDateProxy proxy1(date);
                bdet_PackedCalendar_IteratorDateProxy proxy2(proxy1);
        ...
        }
        {
            ...
            }
            {
                ...
                bdet_PackedCalendar obj(bdet_Date(1, 1, 1),
                                         bdet_Date(9999, 12, 31),
                                         &testAllocator);
...
DEFINE_TEST_CASE(3) {
        ...
        //      bdet_PackedCalendar& hh(bdet_PackedCalendar *, const char *)
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(2) {
        ...
        if (verbose) cout << "\nTesting 'addWeekendDay'." << endl;
        {
            ...
            ASSERT(bdet_Date(1,1,1) == X.beginWeekendDaysTransitions()->first);
...
DEFINE_TEST_CASE(1) {
        ...
        ASSERT(bdet_Date(1,1,1) == cal.beginWeekendDaysTransitions()->first);
